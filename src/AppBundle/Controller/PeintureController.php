...
class PeintureController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $peintures = $em->getRepository('AppBundle:Peinture')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\PeintureType', $peinture);
    ...
    {
        $deleteForm = $this->createDeleteForm($peinture);
        $editForm = $this->createForm('AppBundle\Form\PeintureType', $peinture);
