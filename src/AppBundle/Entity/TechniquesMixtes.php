 ...
 * TechniquesMixtes
 *
 * @ORM\Table(name="techniques_mixtes")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\TechniquesMixtesRepository")
 */
class TechniquesMixtes
{
    /**
     * @var int
     *
